...
/**
 * @brief   Enable global IRQ with mask 使能全局中断
 *
...
/**
 * @brief   Disable global IRQ with mask 禁止全局中断
 *
...
/**
 * @brief   Enable IRQ from interrupt controller 使能中断控制器
 *
 */
...
/**
 * @brief   Disable IRQ from interrupt controller 禁止中断控制器
 *
 */
...
/**
 * @brief Enable machine timer IRQ 使能机械时间中断
 */
...
/**
 * @brief  Disable machine timer IRQ    禁止机械时间中断
 *
 */
...
/**
 * @brief   Initialize software interrupt   初始化软件中断
 *
 */
...
/**
 * @brief   Enable software interrupt   使能软件中断
 *
 */
...
/**
 * @brief   Disable software interrupt  禁止软件中断
 *
 */
...
/**
 * @brief   Trigger software interrupt  触发软件中断
 *
 */
...
/**
 * @brief   Complete software interrupt 完成软件触发中断
 *
 */
...
#define intc_m_enable_irq(irq) \
    intc_enable_irq(HPM_PLIC_TARGET_M_MODE, irq)    //从机械模式使能中断
...
/*
 * @brief Enable specific interrupt //使能指定的中断
 *
...
/**
 * @brief   Set interrupt priority  //设置中断优先级
 *
 * @param[in] irq Interrupt number
 * @param[in] priority Priority of interrupt
 */
